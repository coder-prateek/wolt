...
export default function TabsComponent() {
    ...
    return (
        <Tabs value={activeTab} onValueChange={setActiveTab} className='rounded-none' variant='line'  >
            <Tabs.List className=' bg-none rounded-none' >
                <Tabs.ScrollView className=' bg-none rounded-none px-2 '>
                    <Tabs.Indicator className=' bg-primary rounded-bl-2xl rounded-tr-2xl' />
                    <Tabs.Trigger value="general" className=' border-primary border px-3 py-1 rounded-bl-2xl rounded-tr-2xl'>
                        <Tabs.Label>General</Tabs.Label>
                    </Tabs.Trigger>
                    <Tabs.Trigger value="notifications" className=' rounded-2xl'>
                        <Tabs.Label>Notifications</Tabs.Label>
                    </Tabs.Trigger>
                    <Tabs.Trigger value="profile" className='rounded-2xl'>
